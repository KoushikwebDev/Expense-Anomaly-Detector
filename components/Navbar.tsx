        ...
        <div className="relative rounded-full border border-white/20 dark:border-white/10 bg-white/70 dark:bg-black/70 backdrop-blur-xl shadow-lg dark:shadow-purple-900/10">
          <div className="flex items-center justify-between h-14 px-6">
            ...
            <div className="hidden md:flex items-center gap-4">
              ...
              <button onClick={() => router.push('/upload')} className="px-4 py-2 rounded-full bg-black dark:bg-white text-white dark:text-black text-sm font-medium hover:bg-gray-800 dark:hover:bg-gray-200 transition-all hover:scale-105 active:scale-95">
                Get Started
              </button>
            </div>
          ...
          >
            <div className="rounded-2xl bg-white/90 dark:bg-black/90 backdrop-blur-xl border border-gray-200 dark:border-gray-800 shadow-2xl p-4 space-y-2">
              ...
              <div className="pt-2 border-t border-gray-200 dark:border-gray-800 mt-2">
                <button onClick={() => { setIsOpen(false); router.push('/upload'); }} className="w-full py-3 rounded-xl bg-black dark:bg-white text-white dark:text-black font-medium hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors">
                  Get Started
                </button>
              </div>
            </div>
